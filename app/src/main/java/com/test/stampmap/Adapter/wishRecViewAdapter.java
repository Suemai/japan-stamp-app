...
public class wishRecViewAdapter extends RecyclerView.Adapter<wishRecViewAdapter.ViewHolder> {
    ...
    public wishRecViewAdapter(Context context, ArrayList<StampSet>stamps){
